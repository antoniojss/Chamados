...
<form action="/chamados/chamado/edit" method="post" class="form-default">
	...
	<h2 class="h3 mb-3 font-weight-normal">Lista Acompanhamento - Chamados </h2>
	
	<button class="btn btn-primary btn-sm" onclick="forms[0].action='/chamados/acompanhamento/edit'">Novo Chamado</button>
	<br><br>
	<div style="display:flex; justify-content: center; align-items: center; ">
		<div id="div_displaytagTable">
		
			<display:table name="chamadosLst" requestURI="/chamados/acompanhamento/list" sort="page" export="true">
				<display:caption media="pdf">Lista Acompanhamento - Chamados</display:caption>
				...
				<display:column title="editar" href="read" paramId="chamado.chaId" paramProperty="chaId" media="html">
					editar
				</display:column>
